...
const save = () => {
  if (!localValue.value || localValue.value < 1) {
    error.value = 'Bitte geben Sie eine Dauer von mindestens 1 Jahr ein.';
    return;
  }
  if (localValue.value > 100) {
    error.value = 'Die maximale Dauer beträgt 100 Jahre.';
    return;
  }
