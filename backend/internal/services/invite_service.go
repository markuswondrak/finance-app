...
func (s *InviteService) CreateInvite(workspaceID uint, inviterID uint, email string, inviterName string) (*models.Invite, error) {
...
func (s *InviteService) ValidateInvite(token string) (*models.Invite, error) {
